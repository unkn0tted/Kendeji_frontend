...
export const useIsLoadingUser = () =>
  useGlobalStore((state) => state.isLoadingUser);
export const useSubscriptionLinkConfigStatus = () =>
  useGlobalStore((state) => state.subscriptionLinkConfigStatus);
...
export const useClearUserLoading = () =>
  useGlobalStore((state) => state.clearUserLoading);
export const useSetSubscriptionLinkConfigStatus = () =>
  useGlobalStore((state) => state.setSubscriptionLinkConfigStatus);
export const useGetUserSubscribe = () =>
  useGlobalStore((state) => state.getUserSubscribe);
export const useGetAppSubLink = () =>
  useGlobalStore((state) => state.getAppSubLink);

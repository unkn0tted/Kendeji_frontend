...
const PLAN_THEMES: PlanTheme[] = [
  {
    accent: "oklch(0.68 0.18 354)",
    accentDeep: "oklch(0.58 0.17 350)",
    accentSoft: "oklch(0.9 0.07 354 / 0.36)",
    shadow: "oklch(0.64 0.17 354 / 0.34)",
    icon: "lucide:zap",
  },
  {
    accent: "oklch(0.71 0.16 340)",
    accentDeep: "oklch(0.61 0.15 336)",
    accentSoft: "oklch(0.9 0.07 340 / 0.34)",
    shadow: "oklch(0.65 0.15 340 / 0.32)",
    icon: "lucide:radar",
  },
  {
    accent: "oklch(0.72 0.16 8)",
    accentDeep: "oklch(0.62 0.16 3)",
    accentSoft: "oklch(0.91 0.065 8 / 0.34)",
    shadow: "oklch(0.66 0.15 8 / 0.32)",
    icon: "lucide:package",
  },
  {
    accent: "oklch(0.67 0.17 325)",
    accentDeep: "oklch(0.57 0.16 322)",
    accentSoft: "oklch(0.89 0.07 325 / 0.34)",
    shadow: "oklch(0.62 0.15 325 / 0.3)",
    icon: "lucide:server",
  },
  {
    accent: "oklch(0.7 0.16 365)",
    accentDeep: "oklch(0.6 0.15 360)",
    accentSoft: "oklch(0.9 0.07 365 / 0.34)",
    shadow: "oklch(0.64 0.15 365 / 0.3)",
    icon: "lucide:rocket",
  },
];
